  ...
  <footer class="py-32 px-6 text-center space-y-16">
    ...
    <div class="max-w-4xl mx-auto space-y-12">
       ...
       <div class="flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-black uppercase tracking-[0.3em] opacity-40">
          ...
          <a target="_blank" rel="noopener noreferrer" href="mailto:${content.email || 'contact@brand.com'}" class="hover:text-[var(--primary)] transition-colors">${content.email || 'contact@brand.com'}</a>
       </div>
    </div>
  </footer>
`;
...
export const FOOTER_DARK_SASS = (content: any) => `
     <footer class="py-12 px-6 bg-[var(--bg)] text-center text-[var(--text)]/60 text-xs font-mono border-t border-[var(--text)]/5 transition-colors duration-500">
         <a target="_blank" rel="noopener noreferrer" href="mailto:${content.footerEmail || content.email || ''}" class="block mb-8 text-xl text-[var(--text)]/80 hover:text-[var(--primary)] transition-colors">${content.footerEmail || content.email || 'Contact'}</a>
...
export const FOOTER_AGENCY_BOLD = (content: any) => `
    <footer data-section="footer" class="bg-[var(--bg)] text-[var(--text)] py-16 px-6 text-center border-t border-[var(--text)]/5 transition-colors duration-500">
         ...
         <a target="_blank" rel="noopener noreferrer" href="mailto:${content.email || ''}" class="text-2xl md:text-4xl text-[var(--primary)] hover:text-[var(--heading)] transition-colors underline decoration-2 underline-offset-8" data-field="email">${content.email || 'Contact'}</a>

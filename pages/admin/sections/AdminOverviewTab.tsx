...
const AdminOverviewTab: React.FC<AdminOverviewTabProps> = ({ stats, users, portfolios }) => {
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
        <AdminStatCard label="Total Revenue" value={`₦${(stats?.totalRevenue || 0).toLocaleString()}`} icon={Zap} color="bg-amber-500" />
